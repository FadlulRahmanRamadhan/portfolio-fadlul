    ...
    <main className="bg-[#0f0f1a] text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full bg-[#0f0f1a]/90 backdrop-blur-md z-50">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center p-4 sm:p-6 gap-4 sm:gap-0">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 bg-black/40 px-3 sm:px-6 py-2 sm:py-3 rounded-2xl">
            <a
              href="#beranda"
              className="text-sm sm:text-base hover:text-purple-500 hover:-translate-y-1 transition-all duration-300"
            >
              Home
            </a>
            <a
      ...
      >
        ...
        >
          ...
          >
            <a
              href="/cv-fadlul.pdf"
              download
              className="bg-purple-600 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl hover:bg-purple-700 hover:scale-105 hover:-translate-y-1 transition-all duration-300 cursor-pointer text-sm sm:text-base"
            >
              Download CV
            </a>
            ...
            <button
              ...
              className="bg-gray-700 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl hover:bg-gray-600 hover:scale-105 hover:-translate-y-1 transition-all duration-300 cursor-pointer text-sm sm:text-base"
            >
              View Projects
            </button>
          </div>
        ...
        <img
          ...
          src="/foto-wisuda.jpg"
          alt="Foto Wisuda"
          className="w-40 h-56 sm:w-48 sm:h-64 md:w-56 md:h-80 lg:w-[350px] lg:h-[500px] object-cover rounded-[120px] sm:rounded-[160px] lg:rounded-[180px] border-4 border-purple-500 transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:rotate-2 hover:shadow-[0_0_50px_rgba(168,85,247,0.8)] cursor-pointer"
        />
      </section>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto bg-[#1a1a25] rounded-3xl hover:shadow-[0_0_30px_rgba(168,85,247,0.4)] px-6 sm:px-8 md:px-10 py-6 border border-gray-800">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center sm:items-end gap-4 mt-8">
            ...
            <div className="flex gap-4 sm:gap-6">
              <div className="bg-[#242432] rounded-2xl px-6 sm:px-8 md:px-10 py-4 sm:py-6 text-center">
      ...
      >
        <p className="text-purple-500 uppercase mb-2 text-sm sm:text-base">
          My Stack
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="bg-[#1a1a25] border border-gray-700 rounded-2xl p-4 sm:p-6 hover:-translate-y-2 hover:scale-105 hover:border-purple-500 transition-all duration-300"
            >
      ...
      >
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center text-purple-500 mb-4 sm:mb-6">
          My Projects
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <div
            data-aos="fade-up"
            className="bg-[#1a1a25] border border-gray-700 rounded-3xl p-4 sm:p-6 hover:border-purple-500 hover:-translate-y-2 hover:scale-105 hover:shadow-[0_0_30px_rgba(168,85,247,0.25)] transition-all duration-300"
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-2 sm:gap-0">
              <h3 className="text-xl sm:text-2xl font-bold">
                Mini Cashflow Dashboard
              </h3>
              <span className="border border-purple-500 text-purple-400 text-xs px-3 sm:px-4 py-1 rounded-full">
                Project
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="border border-gray-600 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">
                PHP
              </span>
              <span className="border border-gray-600 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">
                MySQL
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-2 sm:gap-0">
              <h3 className="text-xl sm:text-2xl font-bold">News Portal</h3>
              <span className="border border-purple-500 text-purple-400 text-xs px-3 sm:px-4 py-1 rounded-full">
                Project
              </span>
            </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          <div className="space-y-6">
            <div className="bg-[#1a1a25] p-5 sm:p-6 rounded-2xl border border-gray-800 hover:border-purple-500 hover:-translate-y-2 hover:scale-105 hover:shadow-[0_0_30px_rgba(168,85,247,0.25)] transition-all duration-300 cursor-pointer">
          ...
          <div className="bg-[#1a1a25] p-6 sm:p-8 rounded-2xl border border-gray-800 hover:border-purple-500 hover:shadow-[0_0_30px_rgba(168,85,247,0.25)] transition-all duration-300">
            <form className="space-y-4 sm:space-y-5">
              <input
                type="text"
                placeholder="Your Name"
                className="w-full p-3 sm:p-4 rounded-xl bg-[#242432] outline-none border border-transparent focus:border-purple-500 focus:scale-[1.02] transition-all duration-300 text-sm sm:text-base"
              />
              ...
              <button className="w-full bg-purple-600 py-3 sm:py-4 rounded-xl hover:bg-purple-700 hover:scale-105 hover:-translate-y-1 transition-all duration-300 text-sm sm:text-base">
                Send Message
              </button>
            </form>
          </div>
      ...
      {/* Footer */}
      <footer className="py-8 sm:py-10 border-t border-gray-800 mt-12 sm:mt-20">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8 mb-6 sm:mb-8 text-gray-400">
          <a
            href="#beranda"
            className="hover:text-purple-500 hover:scale-125 hover:-translate-y-1 transition-all duration-300 text-sm sm:text-base"
          >
            Home
          </a>
          <a
        ...
        <div className="flex justify-center gap-6 sm:gap-8 text-2xl sm:text-3xl mb-6 sm:mb-8">
          <a
            ...
            target="_blank"
            className="hover:text-purple-500 hover:scale-125 hover:-translate-y-1 transition-all duration-300"
          >
            <FaGithub />
          </a>
          <a
